    ...
    <div class="reply_content"><!-- 이전페이지 -->
        ...
        <div class="profile_box">
           <div class="modify_txt">
               <ul>
                   <li>
                       <div class="profile_left">재료</div>
                       <div class="profile_right">
                           <div class="form_para">
                              <input type="text" name="keyword_ingredient" id="keyword_ingredient" value="" maxlength="50" placeholder="식재료명을 입력하세요" class="textbox" autofocus="" required="">
                            </div>
                       </div>
                   </li>
   ...
   <div class="sub_txt pop_txt">레시피 등록</div>
    ...
    <div class="profile_box2">
      <div class="recipe_material">
        ...
        <div class="ico_btn8" onclick="ShowInput()">+ 식재료 입력</div>
...
<script>
    ...
    $(document).on('keyup', '#keyword_ingredient', function() {
        ...
        if(k != "") {
            ...
            var temp = $("#search_box_ingredient ul li:contains('"+k+"')");
            $(temp).show();
        } else {
    ...
    $(document).on('click', '.ico_confirm3', function() {
        location.href = "./pop_register.php?temp=<?=$temp?>";
    });
    ...
    $(document).on('click', '.ico_confirm2', function() {
        ...
        $.ajax({
            cache: false,
            type: "POST",
            url : "./ajax_recipe_add2.php",
            data: formData,
            dataType:"json",
            success : function(data, status, xhr) {
                console.log(data);
                location.href="./pop_register3.php?temp=<?=$temp?>";
            },
