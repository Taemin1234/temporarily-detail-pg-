...
$stmt->bind_result($recipe_idx, $tip, $youtube);
$stmt->store_result();
...
$sql = "
    ...
    FROM 
        attachment
    WHERE
        from_content_id = '$r_idx' AND from_table_id='recipe_interview' AND ordering_index = '0' ";
...
<div id="container"> 
   <div class="sub_txt pop_txt">레시피 수정</div>
                    ...
                    <div class="profile_right">
                        ...
                        <div class="plus_file">
                            <div class="table_file">
                                <div class="filebox"><label for="ex_file_0">불러오기</label><input type="file" id="ex_file_0" name="ex_file_0"></div>
    ...
    <div class="register_btn">
          <div class="ico_confirm3"><a href="./pop_modify3.php?idx=<?=$r_idx?>"><img src="/img/ico_arrow.svg">이전 페이지</a></div>
...
<script>
    ...
    $(document).on('click', '.ico_confirm2', function() {
        ...
        $.ajax({
            ...
            type: "POST",
            url : "./ajax_recipe_modify4.php",
            data: data,
            timeout: 600000,
            success : function(data, status, xhr) {
                console.log(data);
                location.href="./pop_modify5.php?idx=<?=$r_idx?>";
            },
