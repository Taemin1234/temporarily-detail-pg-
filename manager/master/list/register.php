        ...
        <div class="search_box">
            <div class="search_tag">
               <!-- 해당태그를 클릭시 창이 닫기며 빈칸에 태그가 입력되도록 해주세요 -->
                ...
                <a href="#" class="search_recipe">한상차림</a>
                <a href="#" class="search_recipe">고기요리</a>
                <a href="#" class="search_recipe">채식요리</a>
                <a href="#" class="search_recipe">건강요리</a>
                <a href="#" class="search_recipe">디저트</a>
...
<div id="container"> 
  ...
  <div class="ico_confirm4"><a href="/master/list/register2.php">다음 페이지<img src="/img/ico_arrow.svg"></a></div>
