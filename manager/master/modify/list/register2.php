               ...
               <ul>
                   <li>
                       ...
                       <div class="profile_right">
                           <div class="form_para">
                              <input type="text" name="Season" value="" maxlength="50" placeholder="식재료명을 입력하세요" class="textbox" autofocus="" required="">
                            </div>
                       </div>
                   </li>
           ...
           <!-- 처음엔 보여지지않고 양념명의 input을 클릭하여 검색하면 뿌려지는 하단 모습입니다 -->
            <div class="search_box">
                ...
                <ul class="search_recent">
                    <li><a href="#">오뎅</a></li>
                    <li><a href="#">오뎅국물끓이기</a></li>
                    <li><a href="#">오징어볶음</a></li>
                    <li><a href="#">오리고기</a></li>
                    <li><a href="#">오리불고기</a></li>
                </ul>
            </div>
       </div>
...
<div id="container"> 
   ...
   <div class="popup-wrap" id="popup">
    ...
    <div class="register_btn">
          <div class="ico_confirm3"><a href="/master/list/register.php"><img src="/img/ico_arrow.svg">이전 페이지</a></div>
          <div class="ico_confirm2"><a href="/master/list/register3.php">다음 페이지<img src="/img/ico_arrow.svg"></a></div>
    </div>
