        ...
        <div class="list_box">
           <div class="list_top">
                <div class="btn_box">
                    ...
                    <a href="/web/influencer/modify.php" class="btn_white">수정</a>
                </div>
                <div class="btn_box">
                    <div class="btn_type" id="modal-open"><img src="/img/ico_bplus.svg">계정생성</div>
                </div>
                        ...
                        <div class="table_line">
                            <ul>
                                <li class="ad_line">
                                    ...
                                    <div class="ad_id ad_table"><input type="text" name="UserId" value="" maxlength="20" placeholder="아이디" class="textbox" required=""></div>
                                </li>
                                <li class="ad_line">
                                ...
                                <li class="ad_line">
                                    ...
                                    <div class="ad_nick ad_table"><input type="text" name="UserNick" value="" maxlength="20" placeholder="닉네임" class="textbox" required=""></div>
                                </li>
                            </ul>
                        </div>
                      </div>
                      <div class="popup-foot">
                        <span class="pop-btn confirm" id="confirm" onClick="window.confirm('계정을 생성하시겠습니까?');">생성</span>
                ...
                <ul>
                   <li class="ad_line">
                    ...
                    <li class="ad_line">
                        ...
                        <div class="ad_tag ad_table">30대·반찬·간식·캠핑파티</div>
                    </li>
                    <li class="ad_line">
