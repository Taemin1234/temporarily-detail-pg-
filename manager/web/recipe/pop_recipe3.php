...
<div id="container" class="recipe_bg">
    <div class="list_box">
        <div class="pop_tit">
           <h10>메인3관리<div class="pop_small">테마목록의 순서를 정하실 수 있습니다.</div></h10>
           <div class="btn_box">
                <div class="btn_type">저장</div>
            </div>
        </div>
       <div class="pop_tit2">
            <h10>분류제목<input type="text" name="RecipeMovie" value="" maxlength="10" placeholder="" class="textbox" autofocus="" required=""></h10>
        </div>
        <div class="table_info">
            <table>
                <thead>
                    <tr>
                        <th class="ga_add">번호</th>
