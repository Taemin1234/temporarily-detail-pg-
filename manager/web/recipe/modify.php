    ...
    <div id="right_box">
       <div class="list_search">
        ...
        <div class="list_box">
           <div class="list_top">
                <div class="btn_box">
                    <a href="/web/recipe/" class="btn_white">취소</a>
                ...
                <ul>
                   <li class="ad_line">
                    ...
                    <li class="ad_line">
                        ...
                        <div class="ad_influ ad_table"><input type="text" name="UserInflu" value="" maxlength="20" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">테마</div>
                        <div class="ad_theme ad_table">
                            <select id="Tag1" name="Tag1" onchange="">
                                <option value="메인요리">메인요리</option>
                                <option value="간편요리">간편요리</option>
                                <option value="한상차림">한상차림</option>
                                <option value="고기요리">고기요리</option>
                                <option value="채식요리">채식요리</option>
                                <option value="건강요리">건강요리</option>
                    ...
                    <li class="ad_line">
                        ...
                        <div class="ad_recipename ad_table"><input type="text" name="RecipeName" value="" maxlength="10" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">레시피설명</div>
                        <div class="ad_recipebox ad_table"><input type="text" name="RecipeBox" value="" maxlength="20" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                    ...
                    <li class="ad_line">
                        ...
                        <div class="ad_ingredient ad_table"><input type="text" name="Ingredient" value="" maxlength="" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">양념</div>
                        <div class="ad_food ad_table"><input type="text" name="RecipeFood" value="" maxlength="" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">TIPS</div>
                        <div class="ad_tips ad_table"><input type="text" name="Ingredient" value="" maxlength="70" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">유튜브</div>
                        <div class="ad_youtube ad_table"><input type="text" name="Youtube" value="" maxlength="" placeholder="" class="textbox" required=""></div>
                    </li>
                    <li class="ad_line">
                        <div class="ad_table_tit">태그</div>
                        <div class="ad_tag ad_table">
                          <div class="search_tag">
                               <!-- 선택이 되었을 시 active가 붙습니다. 4가지 선택 -->
                                <a href="#" class="search_recipe">홈카페</a>
                                <a href="#" class="search_recipe active">캠핑요리</a>
                                <a href="#" class="search_recipe">손님초대</a>
                                <a href="#" class="search_recipe">집밥</a>
                                <a href="#" class="search_recipe active">다이어트</a>
                                <a href="#" class="search_recipe active">인기!핫!</a>
                                ...
                                <a href="#" class="search_recipe active">건강식</a>
                            </div>
                        </div>
                    </li>
                    <li class="ad_line">
                    ...
                    <li class="ad_line">
                        ...
                        <div class="ad_approval ad_table">
                            <div class="product_sort w100">
                                <ul class="">
                                    <li>
                                        <label class="container-radio">
                                          <input type="radio" name="radio">
                                          <span class="checkmark"></span>승인</label>
                                      </li>
                                      <li>
                                        <label class="container-radio">
                                          <input type="radio" name="radio">
                                          <span class="checkmark"></span>미승인</label>
                                      </li>
                                </ul>
                            </div>
                        </div>
